...
<img src="{{ site.baseurl }}/assets/faq-media/image1.png" style="width:6in;height:8.82639in" />

DUBAI BIM Submission
...
1.  I am working on a new BIM model, and it is required that the project complies with DM BIM standards, where shall I get the standard documentation?
...
1.  I am working on a new BIM model, should I use the template provided with the DM BIM templates or use my company template?
...
1.  Is there any specific BIM authoring tool I should use to comply with the DM BIM standard?
...
1.  I am using Revit for modelling; do you have any guidelines to use when using Revit?

Yes. Please check the **BIM E-Submission\_Revit Appendix.pdf** from the standard for details.

1.  The Appendix-B in the standard requests some information related to the site, project and building entities. How should I fill in the information in my BIM model?
...
1.  My BIM model is very large, can I split the model into multiple IFC files?
...
1.  My project contains multiple buildings. How should I export the BIM model to IFC files, and if buildings are made of multiple parts such as podium and towers, how should I export the BIM model to IFC files?
...
<img src="{{ site.baseurl }}/assets/faq-media/image2.png" style="width:5.98889in;height:3.88819in" />
...
1.  We have internally our convention for level naming, do we have to follow the DM BIM standard level naming conventions and why?
...
<img src="{{ site.baseurl }}/assets/faq-media/image3.png" style="width:2.63604in;height:0.87564in" />

1.  Do we have to follow the DM BIM object naming conventions

No. The one in the standard is recommended but you can follow your own object naming conventions.

1.  What are the standard documents I need to use to comply with the minimum information requirements?
...
<img src="{{ site.baseurl }}/assets/faq-media/image4.png" style="width:5.0578in;height:2.11737in" alt="A screenshot of a computer Description automatically generated" />

Help Videos:

[BIM Standards](https://bim.geodubai.ae/ebim/TrainingVideos/content/BIMStandards/BIMStandards.mp4)

1.  Is it required to fill in all information in Appendix-B?
...
1.  I see that there is some information required to be added to the model as per the Appendix-B, but this doesn't apply to my model, what should I do?
...
<img src="{{ site.baseurl }}/assets/faq-media/image5.png" style="width:5.99097in;height:1.81736in" />

1.  I am filling in the building, unit and space usages as per Appendix C, what should I do if I don't find the usage I am looking for in Appendix C?
...
1.  Can I check if I am entering the model information requirement correctly in an early stage of modeling?
...
1.  I am pressed on time, what are the most important entities in the BIM submission I should care about and why?
...
1.  I feel I need to enter lots of information, how can I speed up the process of filling in the information?
...
1.  Under the standard I need to fill in the unit information for spaces, does every space require unit information?
...
1.  Can I still use international classification in my BIM model?

No. For building, unit and space usages, the DM BIM usages must be used as per Appendix-C.

1.  How to export parking slots to IFC correctly?
...
<img src="{{ site.baseurl }}/assets/faq-media/image6.png" style="width:4.47367in;height:2.76498in" />

1.  What should I do if the IFC files exported from my BIM model are too large?
...
1.  The DM BIM guidelines mention that IFC2x3 or IFC4.0 can be used when exporting BIM models to IFC. Which schema should I use?

We highly recommend using IFC4.0 as some users experienced some issues with IFC2.3.

1.  I zipped the IFC files and still the zip file is larger than 100MB?
...
1.  How to correctly specify the gate level details in my BIM model?
...
<img src="{{ site.baseurl }}/assets/faq-media/image7.png" style="width:5.00115in;height:2.31824in" />
...
1.  Should I split model elements such walls, columns and shafts at their corresponding levels and why?
...
1.  Can we have one space for a shaft from top to bottom or do we need to model it in each level?

No. A shaft space must be added on each level; however, you can have a single shaft opening from bottom to top.

1.  Even after setting the predefined type for elements in Revit, the value in IFC file is shown as 'Not Defined'. How can I fix this?
...
1.  Can I export my single Revit project to multiple IFC files without splitting my Revit model?
...
<img src="{{ site.baseurl }}/assets/faq-media/image8.png" style="width:6in;height:3.8125in" />

1.  What information do I need to provide for a space that is part of a unit?
...
1.  I see that the parking slots have some QA/QC issues, why this happing?
...
2.  How to fill in the information requirements defined in Appendix-B for the building levels in my BIM model?
...
<img src="{{ site.baseurl }}/assets/faq-media/image9.png" style="width:6in;height:3.57083in" alt="A screenshot of a computer Description automatically generated" />

1.  What should I do if I cannot find the space usage I am looking for from Appendix\_C?
...
2.  Should the IfcSpace height when exported from the BIM model mark the ceiling bottom or the structural slab bottom?

| When there is no false ceiling, the space height is to the lowest structural element point as shown in the image. | <img src="{{ site.baseurl }}/assets/faq-media/image10.png" style="width:2.67077in;height:1.39037in" /> |
|------------------------------------|------------------------------------|
| When there is false ceiling, the space height to the lowest point of the bottom of false ceiling as shown in the image. | <img src="{{ site.baseurl }}/assets/faq-media/image10.png" style="width:2.65586in;height:1.51196in" /> |

1.  I am a bit confused on level naming, is there an illustration to show how this should be done?

    <img src="{{ site.baseurl }}/assets/faq-media/image11.png" style="width:4.4369in;height:3.29583in" />

2.  I noticed that some elements in the IFC model are not hosted in the correct level. Is there a way to fix this issue?

    When using Revit, this issue can occur in two cases:

3.  When copying elements from one level to another, the host level may not automatically be changed by Revit.

4.  When there are elements that are hosted in a level that is not set to export to IFC, the elements could end up being hosted on the wrong level.
    ...
    <img src="{{ site.baseurl }}/assets/faq-media/image12.png" style="width:6in;height:1.65278in" />

# **Submission Self-Assessment**

1.  Can I check my model quality locally before uploading to the submission platform?
...
1.  Why do I see some spaces in my IFC model flying away from their levels?
...
1.  I am using Revit and when I check the exported model to IFC, I see that some IFC properties of type Boolean is exported ‘false’ although it is ticked in my Revit model, what is causing this issue and how to resolve it?
...
<img src="{{ site.baseurl }}/assets/faq-media/image13.png" style="width:6in;height:2.30972in" alt="A screenshot of a computer Description automatically generated" />

1.  In the IFC file I see some levels that are not required for submission, is this a problem?
...
<img src="{{ site.baseurl }}/assets/faq-media/image14.png" style="width:4.73191in;height:2.53847in" />

1.  <span id="_Ref177377693" class="anchor"></span>I checked my IFC files in a desktop IFC viewer and I see that IFC Site Z value is different from the Z value of the GA\_GateLevel level, Is this an issue?
...
<img src="{{ site.baseurl }}/assets/faq-media/image15.png" style="width:4.62202in;height:0.73371in" />
...
<img src="{{ site.baseurl }}/assets/faq-media/image16.png" style="width:4.01213in;height:1.24683in" />

<img src="{{ site.baseurl }}/assets/faq-media/image17.png" style="width:3.46703in;height:2.05253in" />

1.  The QA/QC app reports many critical issues. What could be the issues in the BIM models?

Check [**APPENDIX I**](#appendix-i-qaqc-issues) for a list of common QAQC and their reasons and resolution.

1.  Why do I see three types of QA\QC issues (Warning, Error and Critical)?
...
1.  How is the building card generated by the Building Card application?
...
1.  How are the BUA, GFA, GA and NA areas calculated in the building card?

The building card application follows the rules defined in the Dubai building code when calculating the building areas.

1.  I downloaded the building card, how can I compare it with manual calculation?
...
<img src="{{ site.baseurl }}/assets/faq-media/image18.png" style="width:4.59439in;height:1.30226in" alt="A screenshot of a computer Description automatically generated" />
...
<img src="{{ site.baseurl }}/assets/faq-media/image19.png" style="width:6in;height:3.15069in" alt="A screenshot of a computer Description automatically generated" />

1.  My manual calculation of the building card doesn't match the value from the platform, why?
...
1.  I have my IFC files ready for submission, what should I do next?
...
<img src="{{ site.baseurl }}/assets/faq-media/image20.png" style="width:2.84352in;height:2.78494in" />

1.  Should my BIM submission include any other files besides the IFC models?

No. We only ask for the IFC models. In some cases, we may ask you to include an additional attachment.

1.  When I try to upload the submission zip file to the BIM service on BuildInDubai website I get an error, what should I do?
...
<img src="{{ site.baseurl }}/assets/faq-media/image21.png" style="width:3.69364in;height:2.10782in" />
...
1.  My model is uploaded successfully to the BuildInDubai site, how I can see it in the platform?
...
<img src="{{ site.baseurl }}/assets/faq-media/image22.png" style="width:6in;height:1.43819in" />

1.  <span id="_Ref177041253" class="anchor"></span>I successfully uploaded my IFC models to the DM BIM platform, what I should do next?
...
1.  I need to check the model visualization by checking each floor, how can I do this on the platform?
...
1.  How can I check that I comply with the minimum information requirements?

See Question [‎](#_Ref177041253).

1.  How can I check that my model is geolocated correctly?
...
<img src="{{ site.baseurl }}/assets/faq-media/image23.png" style="width:2.95169in;height:2.54317in" />

1.  I reviewed the e-checking results, but I think there are few false positive errors, should I worry?

No. The DM permitting engineer will review the e-checking results and only ask for fixing any real violations.

1.  I believe my uploaded model to the platform meets the minimum information requirements, what should I do next?

You can submit the model for review by DM engineer.

1.  I have received an email from the permitting engineer saying my BIM submission doesn't meet the minimum requirements, what do I do next?
...
1.  Does the approval of my BIM submission mean I can get the BIM permit?

No. The approval is only regarding complying with the DM BIM submission requirement.

1.  Why model upload to the Build In Dubai platform fails?
...
1.  Where can download the DM BIM standard, sample and related resources?

Latest material can be found on <https://buildindubai.gov.ae/bim>

1.  Is there any recorded help video?

Yes. The are help videos available on <https://buildindubai.gov.ae/bim>

1.  I still feel that I have questions I don't find the answer for online, who should I contact?
